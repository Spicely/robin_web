...
export default class ProtoSuccess extends Component<RouteComponentProps<any>, IState> {
        ...
        return (
            ...
            >
                <div style={{ paddingTop: getUnit(80) }}>
                    ...
                    <TText className="flex_center">恭喜你,签约成功！</TText>
                    <LText className="flex_center">您已经成功签约,请等待客服审核！</LText>
